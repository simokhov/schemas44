...
public class ObjectFactory {
    ...
    private final static QName _TenderPlanCancel_QNAME = new QName("http://zakupki.gov.ru/oos/extegration/1", "tenderPlanCancel");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://zakupki.gov.ru/oos/extegration/1", name = "tenderPlanCancel")
