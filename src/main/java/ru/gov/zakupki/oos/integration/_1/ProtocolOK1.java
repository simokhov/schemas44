 ...
 *       &lt;sequence>
 *         &lt;element name="data" type="{http://zakupki.gov.ru/oos/types/1}protocolOK1Type"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "protocolOK1")
public class ProtocolOK1
    extends As2PacketType
{

    @XmlElement(required = true)
    protected ProtocolOK1Type data;
     ...
     * @return
     *     possible object is
     *     {@link ProtocolOK1Type }
     *     
     */
    public ProtocolOK1Type getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ProtocolOK1Type value) {
        this.data = value;
    }
