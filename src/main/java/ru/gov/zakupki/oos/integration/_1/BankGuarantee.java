 ...
 *       &lt;sequence>
 *         &lt;element name="data" type="{http://zakupki.gov.ru/oos/types/1}zfcs_bankGuaranteeType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "bankGuarantee")
public class BankGuarantee
    extends As2PacketType
{

    @XmlElement(required = true)
    protected ZfcsBankGuaranteeType data;
     ...
     *     
     */
    public ZfcsBankGuaranteeType getData() {
        return data;
    }
     ...
     *     
     */
    public void setData(ZfcsBankGuaranteeType value) {
        this.data = value;
    }
