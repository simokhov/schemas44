...
@XmlSeeAlso({
    ...
    FcsSecondPartAppOpening.class,
    CpNoticeDeviation.class,
    ...
    MasterData.class,
    EventPlan.class,
    EpNotificationEZakKD.class,
    FcsTimeEF.class,
    Confirmation.class,
    FcsContractSign.class,
    Contract.class,
    CpProtocolDisagreements.class,
