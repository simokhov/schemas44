...
/**
 * Тип: Протокол рассмотрения и оценки первых частей заявок на участие в ЭOKД (двухэтапный конкурс в электронной форме);
 *  внесение изменений
 * 
 * <p>Java class for protocolEOKD2Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolEOKD2Type">
 *   &lt;complexContent>
...
@XmlType(name = "protocolEOKD2Type", propOrder = {
    "protocolInfo"
})
public class ProtocolEOKD2Type
    extends ProtocolType
{

    @XmlElement(required = true)
    protected ProtocolEOKD2Type.ProtocolInfo protocolInfo;
     ...
     * @return
     *     possible object is
     *     {@link ProtocolEOKD2Type.ProtocolInfo }
     *     
     */
    public ProtocolEOKD2Type.ProtocolInfo getProtocolInfo() {
        return protocolInfo;
    }
     ...
     *     
     */
    public void setProtocolInfo(ProtocolEOKD2Type.ProtocolInfo value) {
    ...
    public static class ProtocolInfo {
        ...
        protected ProtocolEOKD2Type.ProtocolInfo.ApplicationsInfo applicationsInfo;
         ...
         * @return
         *     possible object is
         *     {@link ProtocolEOKD2Type.ProtocolInfo.ApplicationsInfo }
         *     
         */
        public ProtocolEOKD2Type.ProtocolInfo.ApplicationsInfo getApplicationsInfo() {
         ...
         *     
         */
        public void setApplicationsInfo(ProtocolEOKD2Type.ProtocolInfo.ApplicationsInfo value) {
