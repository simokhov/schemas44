...
/**
 * Тип: Выписка из протокола проведения ЭЗП (Запрос предложений в электронной форме);
 *  внесение изменений
 * 
 ...
 *                                         &lt;/complexType>
 *                                       &lt;/element>
 *                                       &lt;element name="appParticipant" type="{http://zakupki.gov.ru/oos/EPtypes/1}participantType"/>
