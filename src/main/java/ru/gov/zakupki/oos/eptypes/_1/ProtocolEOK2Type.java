...
/**
 * Тип: Протокол рассмотрения и оценки вторых частей заявок на участие в ЭOK (открытый конкурс в электронной форме);
 *  внесение изменений
 * 
 * <p>Java class for protocolEOK2Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolEOK2Type">
 *   &lt;complexContent>
...
@XmlType(name = "protocolEOK2Type", propOrder = {
    "protocolInfo"
})
public class ProtocolEOK2Type
    extends ProtocolType
{

    @XmlElement(required = true)
    protected ProtocolEOK2Type.ProtocolInfo protocolInfo;
     ...
     * @return
     *     possible object is
     *     {@link ProtocolEOK2Type.ProtocolInfo }
     *     
     */
    public ProtocolEOK2Type.ProtocolInfo getProtocolInfo() {
        return protocolInfo;
    }
     ...
     *     
     */
    public void setProtocolInfo(ProtocolEOK2Type.ProtocolInfo value) {
    ...
    public static class ProtocolInfo {
        ...
        @XmlElement(required = true)
        protected ProtocolEOK2Type.ProtocolInfo.ApplicationsInfo applicationsInfo;
         ...
         * @return
         *     possible object is
         *     {@link ProtocolEOK2Type.ProtocolInfo.ApplicationsInfo }
         *     
         */
        public ProtocolEOK2Type.ProtocolInfo.ApplicationsInfo getApplicationsInfo() {
         ...
         *     
         */
        public void setApplicationsInfo(ProtocolEOK2Type.ProtocolInfo.ApplicationsInfo value) {
