...
/**
 * Тип: Протокол подведения итогов ЭOK-ОУ (открытый конкурс с ограниченным участием в электронной форме);
 *  внесение изменений
 * 
 * <p>Java class for protocolEOKOU3Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="protocolEOKOU3Type">
 *   &lt;complexContent>
...
@XmlType(name = "protocolEOKOU3Type", propOrder = {
    "protocolInfo"
})
public class ProtocolEOKOU3Type
    extends ProtocolType
{

    @XmlElement(required = true)
    protected ProtocolEOKOU3Type.ProtocolInfo protocolInfo;
     ...
     * @return
     *     possible object is
     *     {@link ProtocolEOKOU3Type.ProtocolInfo }
     *     
     */
    public ProtocolEOKOU3Type.ProtocolInfo getProtocolInfo() {
        return protocolInfo;
    }
     ...
     *     
     */
    public void setProtocolInfo(ProtocolEOKOU3Type.ProtocolInfo value) {
    ...
    public static class ProtocolInfo {
        ...
        @XmlElement(required = true)
        protected ProtocolEOKOU3Type.ProtocolInfo.ApplicationsInfo applicationsInfo;
         ...
         * @return
         *     possible object is
         *     {@link ProtocolEOKOU3Type.ProtocolInfo.ApplicationsInfo }
         *     
         */
        public ProtocolEOKOU3Type.ProtocolInfo.ApplicationsInfo getApplicationsInfo() {
         ...
         *     
         */
        public void setApplicationsInfo(ProtocolEOKOU3Type.ProtocolInfo.ApplicationsInfo value) {
