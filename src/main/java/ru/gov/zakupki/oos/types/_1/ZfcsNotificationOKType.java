 ...
 *  внесение изменений
 * 
 * <p>Java class for zfcs_notificationOKType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_notificationOKType">
 *   &lt;complexContent>
...
@XmlType(name = "zfcs_notificationOKType", propOrder = {
...
@XmlSeeAlso({
    ZfcsNotificationOKWithControl99NoticeComplianceType.class
})
public class ZfcsNotificationOKType
    extends ZfcsPurchaseNotificationType
{
    ...
    @XmlElement(required = true)
    protected ZfcsNotificationOKType.Lots lots;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link ZfcsNotificationOKType.Lots }
     *     
     */
    public ZfcsNotificationOKType.Lots getLots() {
        return lots;
    }
     ...
     *     
     */
    public void setLots(ZfcsNotificationOKType.Lots value) {
        this.lots = value;
    }
    ...
    public static class Lots {
        ...
        @XmlElement(required = true)
        protected List<ZfcsNotificationOKType.Lots.Lot> lot;
         ...
         * {@link ZfcsNotificationOKType.Lots.Lot }
         * 
         * 
         */
        public List<ZfcsNotificationOKType.Lots.Lot> getLot() {
            if (lot == null) {
                lot = new ArrayList<ZfcsNotificationOKType.Lots.Lot>();
            }
            return this.lot;
        }
