 ...
 *         &lt;element name="quantityPurchase" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="privacy" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="annualVolumeSt30" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="lending" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="singleSupplier" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="nuclearEnergy" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="ZK" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="unnualVolume" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="percent15" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="onlySMP" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="notSMP" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="annualVolumeSMP" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="rateSMP" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                   &lt;element name="SumMaxPrice" type="{http://zakupki.gov.ru/oos/types/1}VolumeType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    extends ZfcsCustomerReportType
{
    ...
    protected List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo> contractInfo;
     ...
     * {@link ZfcsCustomerReportSmallScaleBusinessType.ContractInfo }
     * 
     * 
     */
    public List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo> getContractInfo() {
        if (contractInfo == null) {
            contractInfo = new ArrayList<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo>();
        }
    ...
    public static class ContractInfo {
        ...
        @XmlElement(required = true)
        protected List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product> product;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product }
         * 
         * 
         */
        public List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product> getProduct() {
            if (product == null) {
                product = new ArrayList<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product>();
            }
            return this.product;
        }
        ...
        public static class Product {
            ...
            @XmlElement(required = true)
            protected List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product.FinanceSources> financeSources;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product.FinanceSources }
             * 
             * 
             */
            public List<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product.FinanceSources> getFinanceSources() {
                if (financeSources == null) {
                    financeSources = new ArrayList<ZfcsCustomerReportSmallScaleBusinessType.ContractInfo.Product.FinanceSources>();
                }
    ...
    public static class QuantityPurchase {
        ...
        protected BigDecimal unnualVolume;
        ...
        @XmlElement(name = "SumMaxPrice")
        protected BigDecimal sumMaxPrice;
        ...
        /**
         * Gets the value of the unnualVolume property.
         * 
         * @return
         *     possible object is
         *     {@link BigDecimal }
         *     
         */
        public BigDecimal getUnnualVolume() {
            return unnualVolume;
        }

        /**
         * Sets the value of the unnualVolume property.
         * 
         * @param value
         *     allowed object is
         *     {@link BigDecimal }
         *     
         */
        public void setUnnualVolume(BigDecimal value) {
            this.unnualVolume = value;
        }
        ...
        /**
         * Gets the value of the sumMaxPrice property.
         * 
         * @return
         *     possible object is
         *     {@link BigDecimal }
         *     
         */
        public BigDecimal getSumMaxPrice() {
            return sumMaxPrice;
        }

        /**
         * Sets the value of the sumMaxPrice property.
         * 
         * @param value
         *     allowed object is
         *     {@link BigDecimal }
         *     
         */
        public void setSumMaxPrice(BigDecimal value) {
            this.sumMaxPrice = value;
        }
