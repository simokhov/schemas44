...
/**
 * Итоговый протокол в ЗП  с уведомлением о соответствии контролируемой информации по 99 статье
 * 
 * <p>Java class for zfcs_protocolZPFinalWithControl99NoticeComplianceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_protocolZPFinalWithControl99NoticeComplianceType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://zakupki.gov.ru/oos/types/1}zfcs_protocolZPFinalType">
 *       &lt;sequence>
...
@XmlType(name = "zfcs_protocolZPFinalWithControl99NoticeComplianceType", propOrder = {
    "control99NoticeCompliance"
})
public class ZfcsProtocolZPFinalWithControl99NoticeComplianceType
    extends ZfcsProtocolZPFinalType
{
