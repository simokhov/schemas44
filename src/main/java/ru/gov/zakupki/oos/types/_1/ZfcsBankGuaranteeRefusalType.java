 ...
 *                             &lt;/sequence>
 *                             &lt;sequence>
 *                               &lt;element name="refusal615Reason" type="{http://zakupki.gov.ru/oos/types/1}zfcs_bankGuaranteeRef615ReasonType" maxOccurs="unbounded"/>
 *                             &lt;/sequence>
 *                           &lt;/choice>
 *                         &lt;/restriction>
 *                       &lt;/complexContent>
...
public class ZfcsBankGuaranteeRefusalType {
    ...
    public static class RefusalInfo {
        ...
        public static class RefusalReasons {
            ...
            protected List<ZfcsBankGuaranteeRef615ReasonType> refusal615Reason;
            ...
            /**
             * Gets the value of the refusal615Reason property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the refusal615Reason property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getRefusal615Reason().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ZfcsBankGuaranteeRef615ReasonType }
             * 
             * 
             */
            public List<ZfcsBankGuaranteeRef615ReasonType> getRefusal615Reason() {
                if (refusal615Reason == null) {
                    refusal615Reason = new ArrayList<ZfcsBankGuaranteeRef615ReasonType>();
                }
                return this.refusal615Reason;
            }
