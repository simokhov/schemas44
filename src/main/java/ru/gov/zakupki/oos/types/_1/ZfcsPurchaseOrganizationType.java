...
/**
 * Данные организации из СПЗ для печатной формы
 * 
...
@XmlSeeAlso({
    ru.gov.zakupki.oos.types._1.ZfcsBankGuaranteeType.Bank.class,
    ru.gov.zakupki.oos.types._1.ZfcsBankGuaranteeType.PlacingOrg.class,
    ru.gov.zakupki.oos.types._1.ZfcsBankGuaranteeType.Guarantee.Customer.class,
    ru.gov.zakupki.oos.types._1.ZfcsBankGuaranteeRefusalType.Bank.class,
    ru.gov.zakupki.oos.types._1.ZfcsBankGuaranteeRefusalType.Guarantee.Customer.class
})
