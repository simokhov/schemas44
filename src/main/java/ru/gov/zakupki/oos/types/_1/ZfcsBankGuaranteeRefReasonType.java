...
/**
 * Тип: Причина отказа в принятии банковской гарантии. Ссылка на справочник "Причины отказа в принятии банковской гарантии" (nsiBankGuaranteeRefusalReason)
 * 
...
@XmlType(name = "zfcs_bankGuaranteeRefReasonType", propOrder = {
    "code",
    "name"
})
