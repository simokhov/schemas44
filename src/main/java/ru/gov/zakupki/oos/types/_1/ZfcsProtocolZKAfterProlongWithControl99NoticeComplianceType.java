...
/**
 * Протокол рассмотрения и оценки заявок по результатам продления срока подачи заявок в ЗК  с уведомлением о соответствии контролируемой информации по 99 статье
 * 
 * <p>Java class for zfcs_protocolZKAfterProlongWithControl99NoticeComplianceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_protocolZKAfterProlongWithControl99NoticeComplianceType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://zakupki.gov.ru/oos/types/1}zfcs_protocolZKAfterProlongType">
 *       &lt;sequence>
...
@XmlType(name = "zfcs_protocolZKAfterProlongWithControl99NoticeComplianceType", propOrder = {
    "control99NoticeCompliance"
})
public class ZfcsProtocolZKAfterProlongWithControl99NoticeComplianceType
    extends ZfcsProtocolZKAfterProlongType
{
