 ...
 *         &lt;element name="factDates" type="{http://zakupki.gov.ru/oos/types/1}zfcs_repDates"/>
...
public class ZfcsRepContractInfo {
    ...
    @XmlElement(required = true)
    protected ZfcsRepDates factDates;
    @XmlElement(required = true)
     ...
     *     
     */
    public ZfcsRepDates getFactDates() {
        return factDates;
    }
     ...
     *     
     */
    public void setFactDates(ZfcsRepDates value) {
