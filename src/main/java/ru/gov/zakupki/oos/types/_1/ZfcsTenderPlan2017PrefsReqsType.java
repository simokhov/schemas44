...
/**
 * Преимущества и требования к участникам закупки в позиции плана-графика с 01.01.2017
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="shortName" type="{http://zakupki.gov.ru/oos/types/1}zfcs_prefsReqsShortNameType"/>
...
@XmlSeeAlso({
    ru.gov.zakupki.oos.types._1.ZfcsTenderPlan2017PositionType.Foundations.RequirementsFoundation.RequirementFoundation.class
})
