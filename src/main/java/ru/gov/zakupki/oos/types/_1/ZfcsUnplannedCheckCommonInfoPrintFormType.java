...
/**
 * Тип: Общая информация по внеплановой проверке (для печатной формы)
 * 
 * <p>Java class for zfcs_unplannedCheckCommonInfoPrintFormType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_unplannedCheckCommonInfoPrintFormType">
 *   &lt;complexContent>
...
@XmlType(name = "zfcs_unplannedCheckCommonInfoPrintFormType", propOrder = {
    "createOrganization",
    "createUser",
    "editDate",
    "editOrganization",
...
public class ZfcsUnplannedCheckCommonInfoPrintFormType {
