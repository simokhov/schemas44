...
@XmlType(name = "zfcs_notificationOKOUType", propOrder = {
    ...
    extends ZfcsPurchaseNotificationType
{
    ...
    @XmlElement(required = true)
    protected ZfcsNotificationOKOUType.ProcedureInfo procedureInfo;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link ZfcsNotificationOKOUType.ProcedureInfo }
     *     
     */
    public ZfcsNotificationOKOUType.ProcedureInfo getProcedureInfo() {
     ...
     *     
     */
    public void setProcedureInfo(ZfcsNotificationOKOUType.ProcedureInfo value) {
