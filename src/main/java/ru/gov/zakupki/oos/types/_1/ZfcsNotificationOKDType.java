...
@XmlSeeAlso({
    ZfcsNotificationOKDWithControl99NoticeComplianceType.class
})
    ...
    extends ZfcsPurchaseNotificationType
{
    ...
    public static class Lots {
        ...
        @XmlElement(required = true)
        protected List<ZfcsNotificationOKDType.Lots.Lot> lot;
         ...
         * {@link ZfcsNotificationOKDType.Lots.Lot }
         * 
         * 
         */
        public List<ZfcsNotificationOKDType.Lots.Lot> getLot() {
            if (lot == null) {
                lot = new ArrayList<ZfcsNotificationOKDType.Lots.Lot>();
            }
            return this.lot;
        }
