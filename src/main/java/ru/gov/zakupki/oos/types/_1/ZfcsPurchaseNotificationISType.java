...
@XmlType(name = "zfcs_purchaseNotificationISType", propOrder = {
    "id",
    "externalId",
    "purchaseNumber",
    "docPublishDate",
...
public class ZfcsPurchaseNotificationISType {
    ...
    @XmlElement(required = true)
    protected ZfcsPurchaseNotificationISType.PlacingWay placingWay;
     ...
     * @return
     *     possible object is
     *     {@link ZfcsPurchaseNotificationISType.PlacingWay }
     *     
     */
    public ZfcsPurchaseNotificationISType.PlacingWay getPlacingWay() {
        return placingWay;
    }
     ...
     *     
     */
    public void setPlacingWay(ZfcsPurchaseNotificationISType.PlacingWay value) {
