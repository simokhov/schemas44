...
@XmlSeeAlso({
    ru.gov.zakupki.oos.types._1.ZfcsCheckResultType.Base.PlannedCheck.Orders.class,
    ru.gov.zakupki.oos.types._1.ZfcsUnplannedCheckType.CheckedObject.CheckedOrder.class
})
