...
@XmlSeeAlso({
    ...
    ru.gov.zakupki.oos.types._1.ZfcsLotI111Type.PurchaseObjects.PurchaseObject.KTRU.class,
    ...
    ru.gov.zakupki.oos.types._1.ZfcsContract2015PurchaseObjectInfoType.KTRU.class,
