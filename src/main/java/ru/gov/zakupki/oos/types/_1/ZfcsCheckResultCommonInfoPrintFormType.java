...
/**
 * Тип: Общая информация по результату контроля (для печатной формы)
 * 
 * <p>Java class for zfcs_checkResultCommonInfoPrintFormType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_checkResultCommonInfoPrintFormType">
 *   &lt;complexContent>
...
@XmlType(name = "zfcs_checkResultCommonInfoPrintFormType", propOrder = {
    "createOrganization",
    "createUser",
    "editDate",
    "editOrganization",
...
public class ZfcsCheckResultCommonInfoPrintFormType {
