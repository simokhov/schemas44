...
/**
 * Протокол рассмотрения и оценки заявок в ЗК  с уведомлением о соответствии контролируемой информации по 99 статье
 * 
 * <p>Java class for zfcs_protocolZKWithControl99NoticeComplianceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_protocolZKWithControl99NoticeComplianceType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://zakupki.gov.ru/oos/types/1}zfcs_protocolZKType">
 *       &lt;sequence>
...
@XmlType(name = "zfcs_protocolZKWithControl99NoticeComplianceType", propOrder = {
    "control99NoticeCompliance"
})
public class ZfcsProtocolZKWithControl99NoticeComplianceType
    extends ZfcsProtocolZKType
{
