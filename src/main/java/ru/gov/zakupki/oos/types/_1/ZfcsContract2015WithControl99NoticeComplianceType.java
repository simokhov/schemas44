...
/**
 * Информация о заключенном контракте с 01.01.2015 с уведомлением о соответствии контролируемой информации по 99 статье
 * 
 * <p>Java class for zfcs_contract2015WithControl99NoticeComplianceType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_contract2015WithControl99NoticeComplianceType">
 *   &lt;complexContent>
...
@XmlType(name = "zfcs_contract2015WithControl99NoticeComplianceType", propOrder = {
    "control99NoticeCompliance"
})
public class ZfcsContract2015WithControl99NoticeComplianceType
