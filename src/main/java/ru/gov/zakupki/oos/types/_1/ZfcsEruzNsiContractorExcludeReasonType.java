...
/**
 * Справочник: Основания исключений участника закупки из ЕРУЗ
 * 
 * <p>Java class for zfcs_eruzNsiContractorExcludeReasonType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="zfcs_eruzNsiContractorExcludeReasonType">
 *   &lt;complexContent>
...
@XmlType(name = "zfcs_eruzNsiContractorExcludeReasonType", propOrder = {
    "code",
    "name",
    "isActual"
})
public class ZfcsEruzNsiContractorExcludeReasonType {
