 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="objectInfo" type="{http://zakupki.gov.ru/fz44/https}BOObjectInfoType" maxOccurs="unbounded" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "getBOObjectListResponse")
public class GetBOObjectListResponse {

    protected GetBOObjectListResponse.ErrorsInfo errorsInfo;
    protected GetBOObjectListResponse.ObjectsInfo objectsInfo;
     ...
     * @return
     *     possible object is
     *     {@link GetBOObjectListResponse.ErrorsInfo }
     *     
     */
    public GetBOObjectListResponse.ErrorsInfo getErrorsInfo() {
        return errorsInfo;
    }
     ...
     *     
     */
    public void setErrorsInfo(GetBOObjectListResponse.ErrorsInfo value) {
     ...
     * @return
     *     possible object is
     *     {@link GetBOObjectListResponse.ObjectsInfo }
     *     
     */
    public GetBOObjectListResponse.ObjectsInfo getObjectsInfo() {
        return objectsInfo;
    }
     ...
     *     
     */
    public void setObjectsInfo(GetBOObjectListResponse.ObjectsInfo value) {
    ...
    public static class ObjectsInfo {
        ...
        protected List<BOObjectInfoType> objectInfo;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link BOObjectInfoType }
         * 
         * 
         */
        public List<BOObjectInfoType> getObjectInfo() {
            if (objectInfo == null) {
                objectInfo = new ArrayList<BOObjectInfoType>();
            }
