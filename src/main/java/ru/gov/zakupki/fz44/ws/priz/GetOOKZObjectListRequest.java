 ...
 *         &lt;element name="documentKind" type="{http://zakupki.gov.ru/fz44/ws/priz}OOKZDocumentKindType" minOccurs="0"/>
...
@XmlRootElement(name = "getOOKZObjectListRequest")
public class GetOOKZObjectListRequest {
